...
Nodo::Nodo(long valor, Nodo *padre){   // O(1)
...
bool ArbolBinarioBusqueda::insertar(long valor){     // O(log(n))
...
bool ArbolBinarioBusqueda:: insertar(long valor, Nodo *n){   // O(log(n))
...
Nodo *ArbolBinarioBusqueda::buscar(long valor){       // O(log(n))
...
Nodo *ArbolBinarioBusqueda::buscar(long valor, Nodo *n){    // O(log(n))
